...
if __name__ == "__main__":
    # Interactive mode
    print("🤖 Fabric Data Agent Client Interactive Mode")
    ...
    if TENANT_ID == "your-tenant-id-here" or DATA_AGENT_URL == "your-data-agent-url-here":
        print("❌ Please update TENANT_ID and DATA_AGENT_URL with your actual values before running.")
        exit(1)
    ...
    print("\n✅ Authenticated successfully! You can now ask questions.\n")

    while True:
        question = input("❓ Your question: ").strip()
        if question.lower() in ["exit", "quit"]:
            print("👋 Exiting Fabric Data Agent client. Goodbye!")
            break
